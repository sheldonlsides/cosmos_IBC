...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/sheldonlsides/planet/blog/params
         */
        this.queryParams = (params = {}) => this.request({
            path: `/sheldonlsides/planet/blog/params`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/sheldonlsides/planet/blog/post
         */
        this.queryPostAll = (query, params = {}) => this.request({
            path: `/sheldonlsides/planet/blog/post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
        ...
        this.queryPost = (id, params = {}) => this.request({
            path: `/sheldonlsides/planet/blog/post/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
