...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Post(request) {
        const data = QueryGetPostRequest.encode(request).finish();
        const promise = this.rpc.request("sheldonlsides.planet.blog.Query", "Post", data);
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Query", "TimedoutPost", data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Query", "TimedoutPostAll", data);
