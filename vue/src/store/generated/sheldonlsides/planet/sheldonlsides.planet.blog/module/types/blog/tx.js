...
export class MsgClientImpl {
    ...
    CreateSentPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "CreateSentPost", data);
    ...
    UpdateSentPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "UpdateSentPost", data);
    ...
    DeleteSentPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "DeleteSentPost", data);
    ...
    CreateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "CreateTimedoutPost", data);
    ...
    UpdateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "UpdateTimedoutPost", data);
    ...
    DeleteTimedoutPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "DeleteTimedoutPost", data);
    ...
    SendIbcPost(request) {
        ...
        const promise = this.rpc.request("sheldonlsides.planet.blog.Msg", "SendIbcPost", data);
